...
namespace App\Repositories\Affilate;

use App\Repositories\EloquentRepository;
use App\Services\QueryService;
use Illuminate\Http\Request;

class AffilateRepository extends EloquentRepository implements AffilateRepositoryInterface
{
    public function model()
    {
        return \App\Models\Affilate::class;
    }
