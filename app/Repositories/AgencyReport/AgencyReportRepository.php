...
namespace App\Repositories\AgencyReport;
...
class AgencyReportRepository extends EloquentRepository implements AgencyReportRepositoryInterface
{
    public function model()
    {
        return \App\Models\AgencyReport::class;
    }
